    ...
    class transactionDAL
    {
        ...
        public bool Insert_Transaction(transactionBll t, out int transactionID)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO tbl_transactions (id, grandTotal, transaction_date, tax, discount) VALUES (@id, @grandTotal, @transaction_date, @tax, @discount); SELECT @@IDENTITY;";
